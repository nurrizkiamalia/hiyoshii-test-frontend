...
import { Plus, Check, ChevronsUpDown, PencilIcon } from "lucide-react";
import {
  Command,
  CommandEmpty,
  CommandGroup,
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="h-[90vh] w-full flex flex-col gap-5 items-center">
        <DrawerHeader className="flex flex-col items-center">
          ...
          <DrawerDescription>
            Isi form dan submit untuk mengedit data packing
          </DrawerDescription>
        </DrawerHeader>
            ...
            <Form {...form}>
              ...
              >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="gap-0 ">
                      <FormLabel className="font-semibold text-base">Datetime</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="gap-0 ">
                      <FormLabel className="font-semibold text-base">PIC</FormLabel>
                      <Popover>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="gap-0 ">
                      <FormLabel className="font-semibold text-base">Berat Kotor (kg)</FormLabel>
                      <FormControl>
                ...
                <div className="flex gap-2">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex-1">
                        <FormLabel className="font-semibold text-base">Qty Pack A</FormLabel>
                        <FormControl>
                          <Input type="text" {...field} className="placeholder:text-gray-500" placeholder="0" />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex-1">
                        <FormLabel className="font-semibold text-base">Qty Pack B</FormLabel>
                        <FormControl>
                          <Input type="text" {...field} className="placeholder:text-gray-500" placeholder="0" />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex-1">
                        <FormLabel className="font-semibold text-base">Qty Pack C</FormLabel>
                        <FormControl>
                          <Input type="text" {...field} className="placeholder:text-gray-500" placeholder="0" />
                        </FormControl>
                        <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="gap-0 ">
                      <FormLabel className="font-semibold text-base">Reject (kg)</FormLabel>
                      <FormControl>
